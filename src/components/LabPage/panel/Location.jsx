...
//       {/* Left Side - Text */}
//       <div style={{ flex: 1 }}>
//         <h6 style={{ fontWeight: "500", marginBottom: "8px",color:"#252525",fontSize:"24px"}}>Maheshwari lab</h6>
//         <div style={{ fontSize: "18px", color: "#8E8E8E"}}>
//           1-8-31/1, Minister Road Krishna Nagar Colony, Ramgopalpet, Begumpet,<br />
//           Secunderabad, Telangana 500003
//         </div>
//         <div style={{ fontSize: "18px", marginTop: "12px", color: "#8E8E8E" ,}}>
//           4.5 km | 24min
//         </div>
//       </div>
